...
void NextFrame()
{
  ...
  NOW = SDL_GetTicks();
  fprintf(stdout,"Ticks passed this frame: %i\n", NOW - Then); //how much time has passed in between frames
  FrameDelay(33); /*(33milliseconds) this will make your frame rate about 30 frames per second.  If you want 60 fps then set it to about 15 or 16*/
}
